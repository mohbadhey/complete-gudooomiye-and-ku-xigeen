<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="votes.admin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" id="nj">
<head runat="server">
    <title>Admin </title>
        ...
        <div class="row  ">
             <div class="col-3">  
                 ...
                 <div class="container-fluid bg-info ">
                     ...
                     <h3 class="text-light">postions</h3>
                     
    <p class="text-white ">no of.</p> <span class="text-white h4 " >1</span>
            ...
            <div class="col-3">
                 <div class="container-fluid bg-warning ">
                     ...
                     <h3 class="text-light">candidates </h3>
                     
    <p>no of.</p>  <span class="text-white h4 " >3</span>
...
<div class="col-3"> 
    <div class="container-fluid bg-danger ">
                     ...
                     <h3 class="text-light">voters</h3>
                     
    <p class="text-white ">no of.</p>  <span  class="text-white h4 " id="voters"></span>
        ...
        <div class="container-fluid bg-success ">
                     ...
                     <h3 class="text-light">votes</h3>
                     
    <p class="text-white ">no of.</p>  <span class="text-white h4 " id="votees"></span>
...
<%-- <div class="row p-1">
     ...
     <div class="col-3 mt-2">
          ...
          <div><span class="fw-bold" id="percentageCand1"></span></div>
              <div><span class="fw-bold" id="percentageCand2"></span></div>
              <div><span class="fw-bold" id="percentageCand3"></span></div>
     ...
     <div class="col-1"></div>
       <div class="col-2">   <button id="printButton" type="button" class="btn btn-primary" onclick="printPage()">Print</button></div>
       <div class="col-1"></div>
      ...
      <div class="col-3 ">
          ...
          <div><span class="fw-bold" id="percentageCand14"></span></div>
              <div><span class="fw-bold" id="percentageCand15"></span></div>
              <div><span class="fw-bold" id="percentageCand16"></span></div>
     ...
     <div class="col-1"></div>
        ...
        <div class="row">
            <div class="col-3"></div>
           <%-- <div class="col-4">
                <h4 class="text-white ">Gudoomiyaasha</h4>
        ...
        <!-- Progress bars will be dynamically added here -->
                 ...
                 <div class="col-1"></div>
               <div class="col-4">
                <h4 class="text-white ">Kuxigeenada</h4>
                   <div id="progressBarsContainer1" class="user-container">
        <!-- Progress bars will be dynamically added here -->
    </div>
            </div>
             <div class="col-2"></div>
             <div class="col-1">      <button onclick="printPage()" id="printButton" class="btn btn-success"> Print </button></div>
        ...
        <div class="row mt-3 p-2 ">
            <div class="col-3 text-white">
                ----------------------------- <br />
                Saxiixa xafiiska doorshada
            </div>
            <div class="col-3"></div>
                 <div class="col-3"></div>
             <div class="col-3 text-white ">
                ----------------------------- <br />
                Saxiixa Gudoomiyaha Doorashada
            </div>
        </div>
        ...
        function updateProgressBarUI(data) {
            ...
            for (var i = 0; i < dataArr.length; i++) {
                ...
                var userCardHtml = '<div class="user-card">' +
                    ...
                    '<div><strong class="text-white">' + userName + '</strong></div>' +
                    '<div><strong class="text-white">(' + voteCount +  '  votes)</strong></div>' +
                    '</div>' +
                    '</div>';
