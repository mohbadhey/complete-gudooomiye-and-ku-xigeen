...
<body>
    ...
    <div class="row">
           ...
           <div class="header">
            ...
            <img class="youtube" src="img/klogo-removebg-preview.png" >
 ...
 <%--     </div>--%>
         ...
         /*         productValue = $('input[name="product"]:checked').val();*/
              ...
              /*    var productName = mapProductValueToName(productValue);*/
                  ...
                  if (
                      ...
                      showConfirmationDialog(std, name, xigenName);
                  } else {
          ...
          function showConfirmationDialog(std, name, xigenName) {
              ...
              swalWithBootstrapButtons.fire({
                  ...
                  html: '<span class="text-bold text-bigger text-blue">  GUDOOMIYE KU XIGEEN:<br> ' + xigenName + '</span>',
                  ...
                  if (result.isConfirmed) {
                      ...
                      $.ajax({
                          ...
                          data: "{'std':'" + std + "', 'name':'" + name + "','xigenValue':'" + xigenValue + "'} ",
                          dataType: "json",
                          type: 'POST',
    ...
    // Initialize FastClick
        ...
        if ('addEventListener' in document) {
         ...
         ///*  Add an event listener to a common parent of your card elements*/
         // document.getElementById("cardContainer").addEventListener("click", function (event) {
         //     // Check if the clicked element is a card
         //     if (event.target.classList.contains("card")) {
         //         // Retrieve the data-value attribute of the clicked card
         //         var xigenValue = event.target.getAttribute("data-value");

         //         // Call the function to handle the retrieved value
         //         handleCardClick(xigenValue);
         //     }
         // });

         // function submit() {

         //     var xigenValue = document.getElementById(clickedId).getAttribute("data-value");
         ...
         // function handleCardClick(xigenValue) {
         //     // Perform actions with the retrieved xigenValue
         //     console.log("Clicked card with value: " + xigenValue);

         //     // You can call your existing functions or perform other actions here
         //     var std = document.getElementById("Label1").innerText;
         //     var name = document.getElementById("Label2").innerText;
         //     var xigenName = mapXigenValueToName(xigenValue);

         //     // Check if xigenValue is 4, 5, or 6
         //     if (xigenValue == 4 || xigenValue == 5 || xigenValue == 6) {
         //         showConfirmationDialog(std, name, xigenName);
         //     } else {
         //         // Handle other cases or show an error message
         //         console.log("Invalid selection");
         ...
         //     swalWithBootstrapButtons.fire({
         //         title: "Ma hubtaa ina u codeneyso?",
         //         html: '<span class="text-bold text-bigger text-blue">  <span class="text-green">GUDOOMIYAHA: <br> ' + xigenName + '<br></span></span>',
         //         icon: "warning",
         //         showCancelButton: true,
         //         confirmButtonText: "HAA WAAN HUBAA!",
         //         cancelButtonText: "MAYA!",
